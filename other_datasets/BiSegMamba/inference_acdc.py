...
def test(fold):
    ...
    path = '/data/BiSegMamba/pretrained_weights/acdc/BiSegMamba/3d_fullres/Task001_ACDC/BiSegMamba_trainer_acdc__nnFormerPlansv2.1/fold_0'
    label_path = '/data/BiSegMamba-experiments/data/DATASET_Acdc/nnFormer_raw/nnFormer_raw_data/Task001_ACDC/labelsTs'
    pred_path = '/data/BiSegMamba/pretrained_weights/acdc/BiSegMamba/3d_fullres/Task001_ACDC/BiSegMamba_trainer_acdc__nnFormerPlansv2.1/fold_0/validation_raw'
