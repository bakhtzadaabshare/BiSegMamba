...
from BiSegMamba.experiment_planning.summarize_plans import summarize_plans
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              search_in=(BiSegMamba.__path__[0], "training", "network_training"),
                              base_module='BiSegMamba.training.network_training'):
