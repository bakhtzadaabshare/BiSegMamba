...
from BiSegMamba.run.default_configuration import get_default_configuration
from BiSegMamba.paths import default_plans_identifier
...
def main():
    ...
    if trainer_class is None:
        raise RuntimeError("Could not find trainer class in BiSegMamba.training.network_training")
