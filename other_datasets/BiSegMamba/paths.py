...
my_output_identifier = "BiSegMamba"
default_plans_identifier = "nnFormerPlansv2.1"
default_data_identifier = 'nnFormerData_plans_v2.1'
default_trainer = "BiSegMamba_trainer_acdc"

"""
PLEASE READ paths.md FOR INFORMATION TO HOW TO SET THIS UP
"""

base = os.environ['BiSegMamba_raw_data_base'] if "BiSegMamba_raw_data_base" in os.environ.keys() else None
preprocessing_output_dir = os.environ['BiSegMamba_preprocessed'] if "BiSegMamba_preprocessed" in os.environ.keys() else None
...
if base is not None:
    ...
    print("BiSegMamba_raw_data_base is not defined and model can only be used on data for which preprocessed files "
...
if preprocessing_output_dir is not None:
    ...
    print("BiSegMamba_preprocessed is not defined and model can not be used for preprocessing "
...
if network_training_output_dir_base is not None:
    ...
    print("RESULTS_FOLDER is not defined and BiSegMamba cannot be used for training or "
