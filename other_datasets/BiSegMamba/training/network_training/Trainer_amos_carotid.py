...
from BiSegMamba.inference.segmentation_export import save_segmentation_nifti_from_softmax
...
from BiSegMamba.postprocessing.connected_components import determine_postprocessing
...
from BiSegMamba.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset
from BiSegMamba.training.loss_functions.dice_loss import DC_and_CE_loss
from BiSegMamba.training.network_training.network_trainer_amos_carotid import NetworkTrainer_amos_carotid
...
class Trainer_amos_carotid(NetworkTrainer_amos_carotid):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        """
        super(Trainer_amos_carotid, self).__init__(deterministic, fp16)
    ...
    def preprocess_patient(self, input_files):
        ...
        preprocessor_class = recursive_find_python_class([join(BiSegMamba.__path__[0], "preprocessing")],
                                                         preprocessor_name,
                                                         current_module="BiSegMamba.preprocessing")
        assert preprocessor_class is not None, "Could not find preprocessor %s in BiSegMamba.preprocessing" % \
                                               preprocessor_name
    ...
    def validate(self, do_mirroring: bool = True, use_sliding_window: bool = True, step_size: float = 0.5,
        ...
        if run_postprocessing_on_folds:
            # in the old BiSegMamba we would stop here. Now we add a postprocessing. This postprocessing can remove everything
